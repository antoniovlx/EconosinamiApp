...
if (isPackaged) {
  ...
  let dbFolder = join(appPath, dataSubFolder);
  let dbpath = join(dbFolder, database)

  // copy database if doesn't exist
  fs.copyFile(`../../src/assets/databases/${database}`, dbpath, (err) => {
    if (err) {
      //log.info("database exist")
      console.log("database exist")
      // throw err;
    }
    //log.info('database was copied to destination');
    console.log('database was copied to destination')
  });
}*/
